  ...
  <body>
    ...
    <div class="container-fluid" style="height: 80%; padding: 0">
      <div class="row">
        ...
        <div class="col-md-8 text-center" style="padding-top: 100px">
          <h2><b>Welcome to </b></h2>
          <img src="../images/logo-full-final.png" alt="photo" width="50%" />
        </div>
      </div>
    </div>
    ...
    <div
      ...
      id="footerDiv"
      style="height: 10%; margin-top: 50px"
    >
      <p><b>copyright &copy; eShikhon.com 2023</b></p>
    </div>
  </body>
</html>
