...
<html lang="en">
  ...
  <body id="myPage">
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-4">
                <img src="../images/logo-full-final.png" alt="logo" width="100%">
            </div>
            <div class="col-sm-8 text-justify">
                <p>Best T-Shirt Design MasterClass - Beginner to Pro Live Course.Best T-Shirt Design 
                    MasterClass - Beginner to Pro Live Course.Best T-Shirt Design MasterClass - Beginner 
                    to Pro Live Course,  T-Shirt Design MasterClass-Cisco Certified Networking Associate - 
                    CCNA Live Course,Cisco Certified Networking Associate - CCNA Live Course ,Certified Networking Associate - 
                    CCNA Live Course,Cisco Certified Networking Associate.
            </div>
        </div>
    </div>
    <br><br>
      ...
      <div class="container-fluid" id="teamDivision">
    ...
    <div class="col-sm-4 text-center">
            <img class="img-circle" src="../images/1.jpg" alt="" width="60%">
            <h2>Willam Harry</h2>
            <p><b>CEO, Founder</b></p>
        </div>

        <div class="col-sm-4 text-center">
            <img class="img-circle" src="../images/2.png" alt="" width="60%">
            <h2>Willam Harry</h2>
            <p><b>CEO, Founder</b></p>
        </div>

        <div class="col-sm-4 text-center">
            <img class="img-circle" src="../images/3.png" alt="" width="60%">
            <h2>Willam Harry</h2>
            <p><b>CEO, Founder</b></p>
        </div>
    </div>
